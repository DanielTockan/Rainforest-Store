      ...
      <div className="col-sm-6">
        <div className="card card-height">
          <div className="card-body">
            ...
            <p className="card-text">Come here to update information relating to your login, credentials and username. All fields are required.</p>
          </div>
        </div>
      </div>
      {/* <div className="col-sm-6">
        <div className="card card-height">
          <div className="card-body">
            ...
            <p className="card-text">This section is a work in progress. Featutres for this are to be added soon.</p>
          </div>
        </div>
      </div> */}
    </div>
